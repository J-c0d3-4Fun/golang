...
func myslice() {
	...
	var s []string // sets the variable "s" to an slice of the type string
	...
	// n addition to these basic operations, slices support several more that make them richer than arrays. One is the builtin append, which returns a slice containing one or more new values.
