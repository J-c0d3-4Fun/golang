...
// as containers of text encoded in UTF-8. In other languages, strings are made of “characters”. In Go, the concept of a character is called a rune - it’s an integer that represents a Unicode code point.
...
func strings_runes() {
	...
	// To count how many runes are in a string, we can use the utf8 package. Note that the run-time of RuneCountInString
	// depends on the size of the string, because it has to decode each UTF-8 rune sequentially.
